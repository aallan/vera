...
| v0.0.121 | 27 Apr | **Nested closures + ADT capture work end-to-end** ([#514](https://github.com/aallan/vera/issues/514), [#527](https://github.com/aallan/vera/issues/527)) — closure-lifting becomes a worklist that bubbles inner closures up, with sigs/IDs shared by-reference to avoid name collisions; `_walk_free_vars` now recurses into `AnonFn`. Pair-type captures split into [#535](https://github.com/aallan/vera/issues/535); CVE-2026-3219 ignore dropped (pip 26.1 shipped). |
