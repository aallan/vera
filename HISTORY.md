...
How the Vera compiler was built, from initial commit through Stage 12, across 62 active development days.
...
| v0.0.169 | 11 Jun | The language server gets its user manual (LSP_SERVER.md) and the VS Code extension gains an LSP client — documentation sweep following [#222](https://github.com/aallan/vera/issues/222). |
...
Total: **810+ commits, 171 tagged releases, 62 active development days.**
