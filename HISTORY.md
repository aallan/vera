...
| v0.0.132 | 5 May | **Opaque-handle GC-rooting hygiene — closes [#347](https://github.com/aallan/vera/issues/347) and [#490](https://github.com/aallan/vera/issues/490)** (`#346` deferred — active reclamation needs a heap-wrap-as-ADT design, tracked as follow-up; per-`execute()` leak bounded by Python GC at exit). |
...
| Metric | v0.0.1 (23 Feb) | v0.0.9 (23 Feb) | v0.0.39 (27 Feb) | v0.0.65 (4 Mar) | v0.0.88 (12 Mar) | v0.0.101 (27 Mar) | v0.0.132 (5 May) |
|--------|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
...
| Tests | ~50 | ~300 | ~600 | ~1,400 | ~2,300 | 3,095 | 3,698 |
...
Total: **810+ commits, 132 tagged releases, 54 active development days.**
