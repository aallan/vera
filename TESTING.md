...
# Validation scripts
python scripts/check_conformance.py                  # conformance suite (75 programs, see manifest.json)
...
| `test_conformance.py` | 375 | 102 | Parametrized conformance suite: parse, check, verify, run, format idempotency across 75 programs |
...
├── ...                        # 75 programs total, organized by spec chapter
...
|--------|-------------------|
| `check_conformance.py` | All 75 conformance programs pass their declared level (parse/check/verify/run) |
...
| `check_conformance.py` | All 75 conformance programs pass their declared level |
