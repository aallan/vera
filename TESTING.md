...
| Metric | Value |
|--------|-------|
| **Tests** | 2,419 across 24 files (~24,600 lines of test code) |
...
| `test_prelude.py` | 19 | 339 | Prelude injection: Option/Result/array operation detection, combinator shadowing, type aliases, end-to-end compilation |
