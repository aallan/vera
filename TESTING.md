...
| Metric | Value |
|--------|-------|
| **Tests** | 3,945 across 32 files (~53,574 lines of test code; 3,915 passed + 16 stress, 14 skipped) |
...
```bash
# Via pytest (parametrized — 435 tests)
