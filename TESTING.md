...
| Metric | Value |
|--------|-------|
| **Tests** | 3,567 across 29 files (~34,400 lines of test code; 3,553 passed, 14 skipped) |
...
| `test_codegen_closures.py` | 24 | 643 | Closure lifting, captured variables, higher-order functions |
