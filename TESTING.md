...
| Metric | Value |
|--------|-------|
| **Tests** | 3,111 across 26 files (~34,000 lines of test code) |
...
| `test_cli.py` | 184 | 2,489 | CLI commands (check, verify, compile, run, test, fmt), subprocess integration, JSON error paths, runtime traps, arg validation, multi-file resolution, IO exit codes |
