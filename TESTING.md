...
| Metric | Value |
|--------|-------|
| **Tests** | 3,242 across 27 files (~34,000 lines of test code; 3,231 passed, 11 skipped) |
...
| `test_verifier.py` | 124 | 1,754 | Z3 verification, counterexamples, tier classification, call-site preconditions, branch-aware preconditions, pipe operator, cross-module contracts, match/ADT verification, decreases verification, mutual recursion |
