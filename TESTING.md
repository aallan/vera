...
| Metric | Value |
|--------|-------|
| **Tests** | 3,796 across 29 files (~35,670 lines of test code; 3,782 passed, 14 skipped) |
...
| `test_html.py` | 4 | 181 | HTML landing page code samples: parse, check, verify |
