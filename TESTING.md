...
| Metric | Value |
|--------|-------|
| **Tests** | 5,963 across 94 files (~79,000 lines of test code; 5,894 passed + 26 stress, 43 skipped) |
...
# Validation scripts
python scripts/check_conformance.py                  # conformance suite (108 programs, see manifest.json)
...
| `test_conformance.py` | 540 | 124 | Parametrized conformance suite: parse, check, verify, run, format idempotency across 108 programs |
...
├── ...                        # 108 programs total, organized by spec chapter
