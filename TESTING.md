...
| Metric | Value |
|--------|-------|
| **Tests** | 4,359 across 36 files (~56,468 lines of test code; 4,328 passed + 16 stress, 15 skipped) |
...
| `test_browser.py` | 105 | 2,088 | Browser parity: Python/wasmtime vs Node.js/JS-runtime output equivalence across IO, State, contracts, Markdown, Regex, and all compilable examples |
