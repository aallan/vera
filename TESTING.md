...
| Metric | Value |
|--------|-------|
| **Tests** | 3,489 across 28 files (~34,000 lines of test code; 3,475 passed, 14 skipped) |
...
| `test_browser.py` | 96 | 1,516 | Browser parity: Python/wasmtime vs Node.js/JS-runtime output equivalence across IO, State, contracts, Markdown, Regex, and all compilable examples |
