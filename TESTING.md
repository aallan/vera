...
| Metric | Value |
|--------|-------|
| **Tests** | 4,601 across 37 files (~59,400 lines of test code; 4,570 passed + 16 stress, 15 skipped) |
| **Compiler code coverage** | 95% Python, 61% JavaScript — 91% combined (CI minimum: 80%) |
| **Conformance programs** | 91 programs across 9 spec chapters, validating every language feature |
...
# Validation scripts
python scripts/check_conformance.py                  # conformance suite (91 programs, see manifest.json)
...
| `test_conformance.py` | 455 | 102 | Parametrized conformance suite: parse, check, verify, run, format idempotency across 91 programs |
...
├── ...                        # 91 programs total, organized by spec chapter
...
|--------|-------------------|
| `check_conformance.py` | All 91 conformance programs pass their declared level (parse/check/verify/run) |
...
| `check_conformance.py` | All 91 conformance programs pass their declared level |
