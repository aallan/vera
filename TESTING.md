...
| Metric | Value |
|--------|-------|
| **Tests** | 4,575 across 37 files (~59,400 lines of test code; 4,544 passed + 16 stress, 15 skipped) |
...
# Validation scripts
python scripts/check_conformance.py                  # conformance suite (90 programs, see manifest.json)
...
| `test_conformance.py` | 450 | 102 | Parametrized conformance suite: parse, check, verify, run, format idempotency across 90 programs |
...
| `run` | Compiles to WASM and executes correctly | 79 |
...
`pytest tests/ -v` reports 15 skipped tests across two categories:
...
├── ...                        # 90 programs total, organized by spec chapter
...
|--------|-------------------|
| `check_conformance.py` | All 90 conformance programs pass their declared level (parse/check/verify/run) |
...
| `check_conformance.py` | All 90 conformance programs pass their declared level |
