...
| Metric | Value |
|--------|-------|
| **Tests** | 5,916 across 94 files (~79,000 lines of test code; 5,847 passed + 26 stress, 43 skipped) |
| **Compiler code coverage** | 95% Python, 61% JavaScript — 91% combined (CI minimum: 80%) |
| **Conformance programs** | 107 programs across 9 spec chapters, validating every language feature |
...
# Validation scripts
python scripts/check_conformance.py                  # conformance suite (107 programs, see manifest.json)
...
| `test_conformance.py` | 535 | 124 | Parametrized conformance suite: parse, check, verify, run, format idempotency across 107 programs |
...
├── ...                        # 107 programs total, organized by spec chapter
