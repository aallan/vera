...
| Metric | Value |
|--------|-------|
| **Tests** | 5,330 across 46 files (~63,000 lines of test code; 5,294 passed + 16 stress, 20 skipped) |
...
| `test_codegen_modules.py` | 28 | 986 | Cross-module guard rail, cross-module codegen, module-qualified call resolution bypassing a local shadow incl. intra-module siblings (#814 §8.5.3), name collision detection (E608/E609/E610) |
...
| `test_conformance.py` | 505 | 116 | Parametrized conformance suite: parse, check, verify, run, format idempotency across 101 programs |
