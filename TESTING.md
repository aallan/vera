...
| Metric | Value |
|--------|-------|
| **Tests** | 3,751 across 29 files (~35,000 lines of test code; 3,737 passed, 14 skipped) |
...
| `test_codegen_closures.py` | 33 | 1,158 | Closure lifting, captured variables, higher-order functions, iterative-builder shadow-stack regressions (#570), closure return-value shadow-push balance (#593) |
