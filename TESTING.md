...
| Metric | Value |
|--------|-------|
| **Tests** | 6,787 across 104 files (~79,000 lines of test code; 6,698 passed + 26 stress, 63 skipped) |
...
| `test_errors.py` | 60 | 621 | Error code registry, diagnostic formatting, serialisation, SourceLocation, error display sync across all six `E001` `spec_ref` mirrors (README/HTML/spec + `AGENTS.md`'s example JSON and the `build_site.py` generator, #829) |
