...
| Metric | Value |
|--------|-------|
| **Tests** | 3,733 across 29 files (~34,800 lines of test code; 3,714 passed, 14 skipped) |
...
| `test_codegen_closures.py` | 29 | 911 | Closure lifting, captured variables, higher-order functions, iterative-builder shadow-stack regressions (#570) |
