...
| Metric | Value |
|--------|-------|
| **Tests** | 3,249 across 27 files (~34,000 lines of test code; 3,238 passed, 11 skipped) |
...
| `test_verifier.py` | 131 | 1,890 | Z3 verification, counterexamples, tier classification, call-site preconditions, branch-aware preconditions, pipe operator, cross-module contracts, match/ADT verification, decreases verification, mutual recursion, refined String/Float64 param sorts |
