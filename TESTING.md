...
| `test_verifier.py` | 135 | 1,894 | Z3 verification, counterexamples, tier classification, call-site preconditions, branch-aware preconditions, pipe operator, cross-module contracts, match/ADT verification, decreases verification, mutual recursion, refined Bool/String/Float64 param sorts |
...
| `test_codegen_closures.py` | 24 | 640 | Closure lifting, captured variables, higher-order functions |
