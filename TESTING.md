...
| Metric | Value |
|--------|-------|
| **Tests** | 6,098 across 97 files (~79,000 lines of test code; 6,029 passed + 26 stress, 43 skipped) |
| **Compiler code coverage** | 95% Python, 61% JavaScript — 91% combined (CI minimum: 80%) |
| **Conformance programs** | 111 programs across 9 spec chapters, validating every language feature |
...
# Validation scripts
python scripts/check_conformance.py                  # conformance suite (111 programs, see manifest.json)
...
| `test_conformance.py` | 555 | 124 | Parametrized conformance suite: parse, check, verify, run, format idempotency across 111 programs |
...
| `run` | Compiles to WASM and executes correctly | 93 |
...
├── ...                        # 111 programs total, organized by spec chapter
