...
# Validation scripts
python scripts/check_conformance.py                  # conformance suite (149 programs, see manifest.json)
...
| `test_conformance.py` | 745 | 124 | Parametrized conformance suite: parse, check, verify, run, format idempotency across 149 programs |
...
| `run` | Compiles to WASM and executes correctly | 121 |
...
├── ...                        # 149 programs total, organized by spec chapter
