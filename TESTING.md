...
| Metric | Value |
|--------|-------|
| **Tests** | 6,979 across 104 files (~93,700 lines of test code; 6,886 passed + 26 stress, 67 skipped) |
| **Compiler code coverage** | 95% Python, 61% JavaScript — 91% combined (CI minimum: 80%) |
| **Conformance programs** | 148 programs across 9 spec chapters, validating every language feature |
...
| **Contract verification** | 283 of 378 obligations (74.9%) across the 37 examples verified statically (Tier 1) — the denominator grew with the auto-synthesised primitive-op obligations of the soundness campaign |
...
# Validation scripts
python scripts/check_conformance.py                  # conformance suite (148 programs, see manifest.json)
...
| `test_verifier_adt_decreases.py` | 20 | 642 | Match/ADT verification, decreases measures (incl. ADT decreases), mutual recursion (#839 split) |
...
| `test_conformance.py` | 740 | 124 | Parametrized conformance suite: parse, check, verify, run, format idempotency across 148 programs |
...
| `run` | Compiles to WASM and executes correctly | 120 |
...
├── ...                        # 148 programs total, organized by spec chapter
