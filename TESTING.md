...
| Metric | Value |
|--------|-------|
| **Tests** | 3,494 across 28 files (~34,000 lines of test code; 3,480 passed, 14 skipped) |
...
| `test_browser.py` | 96 | 1,556 | Browser parity: Python/wasmtime vs Node.js/JS-runtime output equivalence across IO, State, contracts, Markdown, Regex, and all compilable examples |
