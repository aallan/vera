...
| `test_codegen_invariant_e699.py` | 2 | 104 | `CodegenInvariantError` raised in a translator surfaces as a structured `[E699]` "internal compiler error" at the `_compile_fn` boundary, not a raw traceback (#657 Track 2) |
