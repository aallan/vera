...
| Metric | Value |
|--------|-------|
| **Tests** | 3,802 across 29 files (~35,670 lines of test code; 3,788 passed, 14 skipped) |
...
| `test_wasm_coverage.py` | 226 | 3,952 | WASM coverage gaps: helpers unit tests, inference branches, closure free-var walking, operator/data/context edge cases |
