...
| `test_stress.py` | 14 | 469 | Scale-dependent regression tests (#596) — `@pytest.mark.stress`, skipped by default.  8 logical tests × eager-GC lane parametrisation = 14 test instances.  10K `array_map`, 5K nested-array `array_map`, 1K-deep tail recursion with allocating arg, 20×20 nested array-fold-of-array-fold, 100K `array_fold`, 10K String allocations, 1K `State<Int>` get/put cycles, 10K `IO.print` calls.  Pins #570 / #515 / #593 / #595 / #549 / #487 / #348 / #573 regression coverage |
