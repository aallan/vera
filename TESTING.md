...
| Metric | Value |
|--------|-------|
| **Tests** | 3,247 across 27 files (~34,000 lines of test code; 3,236 passed, 11 skipped) |
...
| `test_verifier.py` | 129 | 1,838 | Z3 verification, counterexamples, tier classification, call-site preconditions, branch-aware preconditions, pipe operator, cross-module contracts, match/ADT verification, decreases verification, mutual recursion |
