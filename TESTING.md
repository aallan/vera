...
| Metric | Value |
|--------|-------|
| **Tests** | 2,903 across 26 files (~33,100 lines of test code) |
...
```bash
# Via pytest (parametrized — 295 tests)
