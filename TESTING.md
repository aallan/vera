...
| Metric | Value |
|--------|-------|
| **Tests** | 4,408 across 36 files (~57,100 lines of test code; 4,377 passed + 16 stress, 15 skipped) |
...
| `test_build_site.py` | 17 | 211 | `_abs_links` unit tests: relative link rewriting, fenced block immunity (backtick and tilde fences, inline backticks inside fences), http/https/fragment pass-through, Vera effect syntax not mis-parsed |
