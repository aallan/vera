...
| Metric | Value |
|--------|-------|
| **Tests** | 5,914 across 94 files (~79,000 lines of test code; 5,845 passed + 26 stress, 43 skipped) |
...
| `test_conformance.py` | 535 | 124 | Parametrized conformance suite: parse, check, verify, run, format idempotency across 106 programs |
