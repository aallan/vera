...
| Metric | Value |
|--------|-------|
| **Tests** | 4,356 across 36 files (~56,383 lines of test code; 4,325 passed + 16 stress, 15 skipped) |
...
| `test_browser.py` | 104 | 2,066 | Browser parity: Python/wasmtime vs Node.js/JS-runtime output equivalence across IO, State, contracts, Markdown, Regex, and all compilable examples |
