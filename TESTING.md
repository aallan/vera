...
| Metric | Value |
|--------|-------|
| **Tests** | 5,559 across 53 files (~63,000 lines of test code; 5,511 passed + 26 stress, 22 skipped) |
...
| `test_codegen_invariant_e699.py` | 2 | 114 | `CodegenInvariantError` raised in a translator surfaces as a structured `[E699]` "internal compiler error" at the `_compile_fn` boundary, not a raw traceback (#657 Track 2) |
