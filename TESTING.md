...
| `test_codegen_modules.py` | 30 | 1,050 | Cross-module guard rail, cross-module codegen, module-qualified call resolution bypassing a local shadow incl. intra-module siblings and where-fn helpers both directions (#814 §8.5.3), name collision detection (E608/E609/E610) |
