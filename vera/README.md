...
The `ERROR_CODES` dict in `errors.py` maps every code to a short description (183 entries — 180 `E` codes and 3 `W` warning codes). Codes are stable across versions — they can be used for programmatic filtering, suppression, and documentation lookups. Formatted output shows the code in brackets: `[E130] Error at line 5, column 3:`.
