...
| `  calls.py` | 1,925 | | Function/constructor/module/ability calls | |
...
| ` ├ context.py` | 1,894 | | Composed WasmContext, expression dispatcher, block translation; the one emission path of a named check's trap (`_emit_trap`) and its entry in the per-module record (#1479) | |
