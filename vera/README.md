...
| `codegen/` | 22,173 | Compile | Codegen orchestrator (mixin package) | `compile()`, `execute()` |
...
| `  core.py` | 4,100 | | CodeGenerator class, orchestration, ability op rewriting (Pass 1.6), skip propagation to callers (#1100) | |
