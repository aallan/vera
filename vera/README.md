...
| `  calls.py` | 1,964 | | Function/constructor/module/ability calls | |
...
| ` ├ context.py` | 1,905 | | Composed WasmContext, expression dispatcher, block translation; the one emission path of a named check's trap (`_emit_trap`) and its entry in the per-module record (#1479) | |
...
| ` ├ operators.py` | 3,161 | | Binary/unary operators, if, quantifiers, assert/assume, old/new | |
