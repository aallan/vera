...
| `lsp/` | 2,388 | Serve | Language Server Protocol over stdio (#222 C/D/E/F) | `create_server()`, `vera lsp` |
...
| `  workflows.py` | 947 | | Skill-layer workflows: enforced edit sequences, applied only through the client (#222 F, #1444) | |
