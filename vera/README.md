...
| `lsp/` | 2,055 | Serve | Language Server Protocol over stdio (#222 C/D/E/F) | `create_server()`, `vera lsp` |
...
| `  server.py` | 302 | | pygls wiring, single-session serialisation, coroutine edit handlers | |
| `  workflows.py` | 789 | | Skill-layer workflows: enforced edit sequences, applied only through the client (#222 F, #1444) | |
