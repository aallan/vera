...
| `  calls.py` | 1,875 | | Function/constructor/module/ability calls | |
...
| ` ├ operators.py` | 3,153 | | Binary/unary operators, if, quantifiers, assert/assume, old/new | |
...
| ` ├ data.py` | 2,379 | | Constructors, match expressions (incl. nested patterns), arrays, indexing | |
