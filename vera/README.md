...
| `  extensions.py` | 267 | | vera/speculativeEdit proof-delta | |
| `  server.py` | 287 | | pygls wiring, single-session serialisation | |
| `  workflows.py` | 629 | | Skill-layer workflows: enforced edit sequences (#222 F) | |
