...
| `types.py` | 969 | Type check | Semantic type representation | `Type`, `is_subtype()` |
...
| `  core.py` | 1,444 | | TypeChecker class, orchestration, contracts, constraint validation | |
| `  resolution.py` | 786 | | AST TypeExpr → semantic Type, inference; the E136 / E338 refusal of a type or effect-row name nothing in scope declares (#1489), with forward references to later declarations kept legal and an instruction that names the cause | |
