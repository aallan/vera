...
# `_validate_wrap_handle` is used internally by `_wrap_handle` (inside
# `execute`); the rest of the ADT memory-layout utilities live in memory.py
# and are imported by their consumers directly (#421).
