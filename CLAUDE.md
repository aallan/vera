...
python scripts/check_conformance.py    # Verify all 56 conformance programs pass their declared level
...
- `tests/conformance/` — 56 conformance programs validating every language feature against the spec
...
- All 56 conformance programs in `tests/conformance/` must pass their declared level
