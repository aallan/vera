...
python scripts/check_conformance.py    # Verify all 55 conformance programs pass their declared level
...
- `tests/conformance/` — 55 conformance programs validating every language feature against the spec
...
- All 55 conformance programs in `tests/conformance/` must pass their declared level
