...
python scripts/check_conformance.py    # Verify all 67 conformance programs pass their declared level
...
- `tests/conformance/` — 67 conformance programs validating every language feature against the spec
...
- All 67 conformance programs in `tests/conformance/` must pass their declared level
