...
python scripts/check_conformance.py    # Verify all 247 conformance programs (positives pass their level; negatives fail with their expected_error E-code)
...
python scripts/check_corpus_canonical.py # Verify all 297 corpus programs are in canonical form (vera fmt)
python scripts/check_examples_readme.py # Verify vera run commands + Demonstrates-column names in examples/README.md
...
- `tests/conformance/` — 247 conformance programs validating every language feature against the spec
