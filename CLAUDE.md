...
python scripts/check_conformance.py    # Verify all 74 conformance programs pass their declared level
...
- `tests/conformance/` — 74 conformance programs validating every language feature against the spec
