...
python scripts/check_conformance.py    # Verify all 57 conformance programs pass their declared level
...
- `tests/conformance/` — 57 conformance programs validating every language feature against the spec
...
- All 57 conformance programs in `tests/conformance/` must pass their declared level
