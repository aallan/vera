...
python scripts/check_conformance.py    # Verify all 60 conformance programs pass their declared level
...
- `tests/conformance/` — 60 conformance programs validating every language feature against the spec
...
- All 60 conformance programs in `tests/conformance/` must pass their declared level
