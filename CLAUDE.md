...
python scripts/check_conformance.py    # Verify all 76 conformance programs pass their declared level
...
- `tests/conformance/` — 76 conformance programs validating every language feature against the spec
