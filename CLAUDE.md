...
python scripts/check_conformance.py    # Verify all 91 conformance programs pass their declared level
...
- `tests/conformance/` — 91 conformance programs validating every language feature against the spec
