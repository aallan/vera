...
python scripts/check_conformance.py    # Verify all 71 conformance programs pass their declared level
...
- `tests/conformance/` — 71 conformance programs validating every language feature against the spec
