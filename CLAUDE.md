...
python scripts/check_conformance.py    # Verify all 90 conformance programs pass their declared level
...
- `tests/conformance/` — 90 conformance programs validating every language feature against the spec
