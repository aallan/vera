...
python scripts/check_conformance.py    # Verify all 64 conformance programs pass their declared level
...
- `tests/conformance/` — 64 conformance programs validating every language feature against the spec
...
- All 64 conformance programs in `tests/conformance/` must pass their declared level
