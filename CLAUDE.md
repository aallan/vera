...
python scripts/check_conformance.py    # Verify all 75 conformance programs pass their declared level
...
- `tests/conformance/` — 75 conformance programs validating every language feature against the spec
