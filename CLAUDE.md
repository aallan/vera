...
python scripts/check_conformance.py    # Verify all 79 conformance programs pass their declared level
...
- `tests/conformance/` — 79 conformance programs validating every language feature against the spec
