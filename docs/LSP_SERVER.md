...
- **VS Code** — the [bundled extension](https://github.com/aallan/vera/blob/main/editors/vscode/) starts the
  server automatically for `.vera` files when a `vera` binary is on
  your `PATH` (configurable via the `vera.lsp.path` setting). See its
  [README](https://github.com/aallan/vera/blob/main/editors/vscode/README.md) for setup.
...
[compiler README](https://github.com/aallan/vera/blob/main/vera/README.md) module map; the design history —
