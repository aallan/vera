...
| WASM call translators: 7 Major bugs remaining (3 Criticals shipped in v0.0.128) — INT64_MIN to_string, array slice i64→i32 narrowing, Map<K, Array<T>> lowering, url_parse/url_join round-trip, base64 `=` validation, parse_nat/int embedded spaces, float fractional carry | [#475](https://github.com/aallan/vera/issues/475) |
