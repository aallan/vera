...
python scripts/check_conformance.py    # All 251 conformance programs hold (positives pass; negatives fail with their E-code)
python scripts/check_examples.py       # All 43 examples must pass
python scripts/check_corpus_canonical.py # All 301 corpus programs in canonical form
```
