...
python scripts/check_conformance.py    # All 62 conformance programs must pass
python scripts/check_examples.py       # All 28 examples must pass
```
