...
- Over 3,000 unit tests plus a 77-program conformance suite
- 30 working example programs
- 137 built-in functions covering strings, arrays, math, parsing, and data types
