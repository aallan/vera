...
runtime check where it can be, and what can be neither proved nor guarded \
is disclosed. \
...
For other models: point them at [`SKILL.md`]({SITE}/SKILL.md) via system prompt, file attachment, or retrieval. It's self-contained and works with any model that reads markdown. Every Vera example in it, and on this page, is checked, verified and, where it names an expected output, run in CI.
