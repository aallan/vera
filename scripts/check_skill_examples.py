...
ALLOWLIST: dict[int, tuple[str, str]] = {
    ...
    716: ("FRAGMENT", "BROKEN closure example (#513): nested closure direct form"),
    739: ("FRAGMENT", "BROKEN/WORKING closure pair (#513): nested closure workaround"),

    # Option/Result combinator examples — bare function calls
    783: ("FRAGMENT", "Option/Result combinator usage examples, bare calls"),
    ...
    811: ("FRAGMENT", "Array built-in examples, bare calls"),
    841: ("FRAGMENT", "Map built-in examples, bare calls"),
    858: ("FRAGMENT", "Set built-in examples, bare calls"),
    872: ("FRAGMENT", "Decimal built-in examples, bare calls"),
    895: ("FRAGMENT", "JSON parse/stringify/get examples, bare calls"),
    908: ("FRAGMENT", "JSON match expression example, bare expression"),
    925: ("FRAGMENT", "JSON typed accessor examples (#366), bare calls"),
    944: ("FRAGMENT", "JSON Layer-2 compound accessor example, bare match"),
    956: ("FRAGMENT", "String built-in examples, bare calls"),
    1000: ("FRAGMENT", "String interpolation examples, bare expressions"),
    1012: ("FRAGMENT", "String search built-in examples, bare calls"),
    1023: ("FRAGMENT", "String transformation built-in examples, bare calls"),
    1035: ("FRAGMENT", "String utility / classifier signatures (#470, #471), bare calls"),

    # Markdown / HTML / Regex built-in usage examples
    1071: ("FRAGMENT", "md_parse / md_render signatures, bare calls"),
    1107: ("FRAGMENT", "HTML built-in examples, bare calls"),
    1123: ("FRAGMENT", "HTML match expression example, bare expression"),
    1138: ("FRAGMENT", "Regex built-in examples, bare calls"),
    1149: ("FRAGMENT", "Regex Result matching example, bare expression"),

    # Numeric + math built-ins
    1161: ("FRAGMENT", "Numeric built-in examples, bare calls"),
    1176: ("FRAGMENT", "Math built-in examples (log/trig/constants/clamp), bare calls"),
    1198: ("FRAGMENT", "Type conversions, bare calls"),
    1211: ("FRAGMENT", "Float64 predicate and constant examples, bare calls"),

    # Contracts
    1240: ("FRAGMENT", "Requires clause example, not full function"),
    1249: ("FRAGMENT", "Ensures clause example, not full function"),
    1279: ("FRAGMENT", "Contracts scaffolding template"),
    1299: ("FRAGMENT", "Quantified expression examples, bare calls"),

    # Effect declarations and handlers
    1317: ("FRAGMENT", "Effect declarations list"),
    1426: ("FRAGMENT", "Async effect declarations list"),
    1446: ("FRAGMENT", "Async effect row declarations, bare clauses"),
    1476: ("FRAGMENT", "Http effect declarations list"),
    1507: ("FRAGMENT", "Inference effect declarations list"),
    1515: ("FRAGMENT", "Effect handler syntax template"),
    1582: ("FRAGMENT", "Handler syntax template, not real code"),
    1599: ("FRAGMENT", "Handler with-clause pseudocode, bare expression"),
    1611: ("FRAGMENT", "Handler with-clause, bare put arm expression"),
    1621: ("FRAGMENT", "Qualified effect calls (State.put, Logger.put)"),

    # Escape sequences and string construction
    1825: ("FRAGMENT", "ANSI cursor-home via string_from_char_code (#513)"),
    1838: ("FRAGMENT", "Comment syntax example"),

    # Common mistakes section — intentionally wrong code
    1877: ("FRAGMENT", "Wrong: missing index on slot reference"),
    1917: ("FRAGMENT", "Wrong: missing contracts"),
    1937: ("FRAGMENT", "Wrong: missing effects clause (with contracts)"),
    1984: ("FRAGMENT", "Wrong: bare @Int + @Int without indices"),
    1989: ("FRAGMENT", "Common mistake example, bare if/else"),
    2066: ("FRAGMENT", "Correct: if/else with braces (common mistakes)"),
    2079: ("FRAGMENT", "Wrong: non-exhaustive match (missing arm)"),
    2086: ("FRAGMENT", "Correct: match expression example (bare)"),
    2096: ("FRAGMENT", "Wrong: if-then-else without braces"),
    2101: ("FRAGMENT", "Wrong: non-exhaustive match (missing None)"),

    # Import syntax — intentionally unsupported
    2112: ("FRAGMENT", "Wrong: import aliasing not supported"),
    2117: ("FRAGMENT", "Correct: import syntax example"),
    2127: ("FRAGMENT", "Wrong: import hiding not supported"),
    2146: ("FRAGMENT", "Correct escape sequence examples, bare strings"),
    2154: ("FRAGMENT", "Wrong: standalone map_new/set_new without type context"),
    2160: ("FRAGMENT", "Correct: map_new/set_new with type context"),
