...
ALLOWLIST: dict[int, tuple[str, str]] = {
    ...
    1392: ("FRAGMENT", "Async effect declarations list"),
    1412: ("FRAGMENT", "Async effect row declarations, bare clauses"),
    1442: ("FRAGMENT", "Http effect declarations list"),
    1473: ("FRAGMENT", "Inference effect declarations list"),
    1481: ("FRAGMENT", "Effect handler syntax template"),
    1548: ("FRAGMENT", "Handler syntax template, not real code"),
    1565: ("FRAGMENT", "Handler with-clause pseudocode, bare expression"),
    1577: ("FRAGMENT", "Handler with-clause, bare put arm expression"),
    1587: ("FRAGMENT", "Qualified effect calls (State.put, Logger.put)"),

    # Escape sequences and string construction
    1791: ("FRAGMENT", "ANSI cursor-home via string_from_char_code (#513)"),
    1804: ("FRAGMENT", "Comment syntax example"),

    # Common mistakes section — intentionally wrong code
    1859: ("FRAGMENT", "Wrong: missing index on slot reference"),
    1883: ("FRAGMENT", "Wrong: missing contracts"),
    1903: ("FRAGMENT", "Wrong: missing effects clause (with contracts)"),
    1926: ("FRAGMENT", "Wrong: bare @Int + @Int without indices"),
    1950: ("FRAGMENT", "Common mistake example, bare if/else"),
    1955: ("FRAGMENT", "Correct: bare @Int + @Int (common mistakes)"),
    2032: ("FRAGMENT", "Wrong: non-exhaustive match (missing arm)"),
    2045: ("FRAGMENT", "Correct: match expression example (bare)"),
    2052: ("FRAGMENT", "Correct: match with Option arms (bare)"),
    2062: ("FRAGMENT", "Wrong: missing braces on if/else branches"),
    2067: ("FRAGMENT", "Correct: if/else with braces (common mistakes)"),

    # Import syntax — intentionally unsupported
    2078: ("FRAGMENT", "Wrong: import aliasing not supported"),
    2083: ("FRAGMENT", "Correct: import syntax example"),
    2093: ("FRAGMENT", "Wrong: import hiding not supported"),
    2112: ("FRAGMENT", "Correct escape sequence examples, bare strings"),
    2120: ("FRAGMENT", "Wrong: standalone map_new/set_new without type context"),
    2126: ("FRAGMENT", "Correct: map_new/set_new with type context"),
