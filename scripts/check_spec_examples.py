...
ALLOWLIST: dict[tuple[str, int], str] = {
    ...
    ("09-standard-library.md", 498): "FRAGMENT",  # array_append signature (no body)
    ("09-standard-library.md", 516): "FRAGMENT",  # array_range signature (no body)
    ("09-standard-library.md", 534): "FRAGMENT",  # array_concat signature (no body)
    ("09-standard-library.md", 552): "FRAGMENT",  # array_slice signature (no body)
    ("09-standard-library.md", 570): "FRAGMENT",  # array_map signature (no body)
    ("09-standard-library.md", 586): "FRAGMENT",  # array_filter signature (no body)
    ("09-standard-library.md", 602): "FRAGMENT",  # array_fold signature (no body)
    ("09-standard-library.md", 792): "FRAGMENT",  # float_to_int signature (no body)
    ("09-standard-library.md", 1196): "FRAGMENT",  # parse_float64 signature (no body)
    ("09-standard-library.md", 1372): "FRAGMENT",  # similarity signature (no body)

    # Chapter 9 — Numeric/string/encoding builtin signatures (no body)
    ("09-standard-library.md", 707): "FRAGMENT",  # round signature (no body)
    ("09-standard-library.md", 724): "FRAGMENT",  # sqrt signature (no body)
    ("09-standard-library.md", 741): "FRAGMENT",  # pow signature (no body)
    ("09-standard-library.md", 1241): "FRAGMENT",  # base64_encode signature (no body)
    ("09-standard-library.md", 1260): "FRAGMENT",  # base64_decode signature (no body)
    ("09-standard-library.md", 1287): "FRAGMENT",  # url_encode signature (no body)
    ("09-standard-library.md", 1306): "FRAGMENT",  # url_decode signature (no body)
    ("09-standard-library.md", 1332): "FRAGMENT",  # url_parse signature (no body)
    ("09-standard-library.md", 1389): "FRAGMENT",  # regex_match signature (no body)
    ("09-standard-library.md", 1405): "FRAGMENT",  # regex_find signature (no body)
    ("09-standard-library.md", 1421): "FRAGMENT",  # regex_find_all signature (no body)
    ("09-standard-library.md", 1437): "FRAGMENT",  # regex_replace signature (no body)
    ...
    ("09-standard-library.md", 414): "FRAGMENT",  # async/await signatures (no body)

    # Chapter 9 — Numeric builtin signatures (no body)
    ("09-standard-library.md", 622): "FRAGMENT",  # abs signature (no body)
    ("09-standard-library.md", 639): "FRAGMENT",  # min signature (no body)
    ("09-standard-library.md", 656): "FRAGMENT",  # max signature (no body)
    ("09-standard-library.md", 673): "FRAGMENT",  # floor signature (no body)
    ("09-standard-library.md", 690): "FRAGMENT",  # ceil signature (no body)
    ...
    ("09-standard-library.md", 840): "FRAGMENT",  # int_to_byte signature (no body)

    # Chapter 9 — Float64 predicates (signatures, no body)
    ("09-standard-library.md", 849): "FRAGMENT",  # float_is_nan signature (no body)
    ("09-standard-library.md", 881): "FRAGMENT",  # float_is_infinite signature (no body)
    ("09-standard-library.md", 900): "FRAGMENT",  # nan signature (no body)
    ...
    ("09-standard-library.md", 1002): "FRAGMENT",  # string_strip signature (no body)
    ("09-standard-library.md", 1018): "FRAGMENT",  # string_char_code signature (no body)
    ...
    ("09-standard-library.md", 1079): "FRAGMENT",  # string_split signature (no body)
    ("09-standard-library.md", 1079): "FRAGMENT",  # string_join signature (no body)
    ("09-standard-library.md", 1108): "FRAGMENT",  # string_from_char_code signature (no body)
    ("09-standard-library.md", 1108): "FRAGMENT",  # string_repeat signature (no body)

    # Chapter 9 — Parsing function signatures (no body)
    ("09-standard-library.md", 1151): "FRAGMENT",  # parse_nat signature (no body)
    ("09-standard-library.md", 1173): "FRAGMENT",  # parse_int signature (no body)
    ("09-standard-library.md", 1218): "FRAGMENT",  # parse_bool signature (no body)

    ("09-standard-library.md", 1352): "FRAGMENT",  # url_join signature (no body)

    # Chapter 9 — Markdown stdlib type (future, uses MdBlock/MdInline types)
    ("09-standard-library.md", 1544): "FUTURE",   # md_parse
    ("09-standard-library.md", 1553): "FUTURE",   # md_render
    ("09-standard-library.md", 1564): "FUTURE",   # md_has_heading
    ("09-standard-library.md", 1573): "FUTURE",   # md_has_code_block
    ("09-standard-library.md", 1582): "FUTURE",   # md_extract_code_blocks
    ("09-standard-library.md", 1606): "FUTURE",   # convert_to_markdown
}
...
CHECK_ALLOWLIST: dict[tuple[str, int], str] = {
    ...
    ("09-standard-library.md", 394): "INCOMPLETE",  # fetch_both uses Http.get (future)
