...
ALLOWLIST: dict[tuple[str, int], str] = {
    ...
    ("09-standard-library.md", 927): "FRAGMENT",  # infinity signature (no body, from FUTURE list)
    ...
    ("09-standard-library.md", 1045): "FRAGMENT",  # string_upper signature (no body, was at 1030)
    ("09-standard-library.md", 1045): "FRAGMENT",  # string_lower signature (no body)
    ("09-standard-library.md", 1060): "FRAGMENT",  # string_replace signature (no body)
    ("09-standard-library.md", 1091): "FRAGMENT",  # string_split signature (no body)
    ("09-standard-library.md", 1106): "FRAGMENT",  # string_join signature (no body, from main list)
    ("09-standard-library.md", 1120): "FRAGMENT",  # string_from_char_code signature (no body)
    ("09-standard-library.md", 1135): "FRAGMENT",  # string_repeat signature (no body, from main list)
