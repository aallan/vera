...
3. [#62](https://github.com/aallan/vera/issues/62) **Map and Set collections** — requires abilities for key constraints (`Eq + Hash`). Unlocks structured data handling. ([PR 1](https://github.com/aallan/vera/pull/332), [PR 2](https://github.com/aallan/vera/pull/336))
