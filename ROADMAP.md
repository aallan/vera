...
13,778 tests, 253 conformance programs, 43 examples, 14 spec chapters.  [KNOWN_ISSUES.md](KNOWN_ISSUES.md) tracks the open bugs (burndown material rather than stage work), plus the *limitations* the stages below retire.
...
| Issue | What |
|---|---|
| [#1459](https://github.com/aallan/vera/issues/1459) | A call precondition and its E532 warning are recorded twice when the callee is a `forall` generic, because the demotion dedup compares the precondition by object identity while a monomorphised instance verifies against a clone. |
