...
5,525 tests, 103 conformance programs, 35 examples, 13 spec chapters.
...
| Issue | What |
|---|---|
| [#832](https://github.com/aallan/vera/issues/832) | Route CLI stdout/stderr + subprocess text I/O through UTF-8 so the `PYTHONUTF8=1` CI backstop can be dropped (AC3 split out of #645, whose file-I/O audit + gate landed in v0.0.190). |
