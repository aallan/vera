...
The compiler was built through eleven stages from February 2026 onwards. **810+ commits, 138 tagged releases (as of v0.0.138), 3,751 tests, 96% coverage, 86 conformance programs, 33 examples, 13 spec chapters.** See [HISTORY.md](HISTORY.md) for the per-stage narrative and per-release table.
