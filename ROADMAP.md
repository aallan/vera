...
| Add mutation testing with mutmut (detection only) | [#387](https://github.com/aallan/vera/issues/387) | 2–4 hours | Measures whether 3,500 tests catch real bugs, not just execute paths |
...
**810+ commits, 118 tagged releases (as of v0.0.118), 3,500 tests, 96% coverage, 79 conformance programs, 32 examples, 13 spec chapters.** See [HISTORY.md](HISTORY.md) for the full narrative of how the compiler was built.
