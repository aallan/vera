...
| Add mutation testing with mutmut (detection only) | [#387](https://github.com/aallan/vera/issues/387) | 2–4 hours | Measures whether 3,590 tests catch real bugs, not just execute paths |
...
**810+ commits, 124 tagged releases (as of v0.0.124), 3,590 tests, 96% coverage, 81 conformance programs, 33 examples, 13 spec chapters.** See [HISTORY.md](HISTORY.md) for the full narrative of how the compiler was built.
