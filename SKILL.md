...
|-----------|---------|-------|
| CLI only accepts `Int` arguments | `vera run file.vera --fn f -- 42` supports integer arguments only. Passing strings, booleans, or compound types via the command line is not yet supported. | [#263](https://github.com/aallan/vera/issues/263) |
