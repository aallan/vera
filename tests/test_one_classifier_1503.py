...
_TARGET_READERS: dict[tuple[str, str, str], str] = {
    ...
    # A container literal's target, for the `Tuple` construction, the array
    # literal and `map_insert`: the type its position handed down (R-1412
    # F3) first, and the recorded one when nothing was handed down.
    ("vera/wasm/operators.py", "OperatorsMixin._container_target_full",
     "_target_codegen_type_full"): _TARGET,
    ("vera/wasm/operators.py", "OperatorsMixin._container_target_refined",
     "_target_codegen_type_refined"): _TARGET,
